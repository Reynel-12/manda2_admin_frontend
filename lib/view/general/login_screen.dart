...
import 'package:manda2_admin_frontend/view/admin/administrator_dashboard_screen.dart';
import 'package:manda2_admin_frontend/view/general/create_account_screen.dart';
  ...
  Widget _buildHeader() {
    return Column(
      children: [
        ...
        const Text(
          'Administra tu plataforma de delivery local',
          style: TextStyle(
            fontSize: 14,
            color: _C.textMuted,
